...
import { Icon } from '@docs/components/ui/icon';
import { TextClassContext } from '@docs/components/ui/text';
...
function ToggleGroupIcon({ className, size = 14, ...props }: React.ComponentProps<typeof Icon>) {
  const textClass = React.useContext(TextClassContext);
  return <Icon className={cn('shrink-0', textClass, className)} size={size} {...props} />;
}
